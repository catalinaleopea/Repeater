...
Software:
Ideea joculului e de a afisa o secventa de sageti pe matrice, iar jucatorul sa o reproduca cu ajutorul a 4 butoane (stanga, dreapta, sus, jos).  
...
Jocul se termina atunci cand utilizatorul introduce o secventa gresita.
Cu ajutorul display-ului LCD afisez un mesaj de inceput, pentru a sugera jucatorului sa apese un buton pentru a juca, apoi incepe afisarea secventei,
urmata de un afisaj special care indica randul jucatorului si un “smiley face” daca datele au fost corecte sau “sad face” altfel.
La sfarsitul jocului ecranul LCD va afisa un mesaj de final, dupa o apasare de buton scorul, iar inca o apasare va insemna optiunea de intoarcere la nivelul 1.
